...
public final class MainActivity extends BaseActivity implements InfoSessionListFragment.Callback {
    ...
    @Inject
    private InfoSessionPreferenceManager mInfoSessionPreferenceManager;
    @Inject
    private InfoSessionManager mInfoSessionManager;
    @Inject
    private InfoSessionUtil mUtil;
