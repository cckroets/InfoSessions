...
public class WebData extends SQLiteOpenHelper
{
   ...
   * @param sessions
   */
  public static void saveSessionsToDB(Context context, Collection<InfoSessionDAO> sessions) {
  ...
  private static class AsyncAddToDB extends AsyncTask<Object, Void, Void> {
    ...
    private Collection<InfoSessionDAO> sessions;

    public AsyncAddToDB(Context context, Collection<InfoSessionDAO> sessions) {
    ...
    {
      for (InfoSessionDAO session : sessions) {
    ...
    private boolean isInDatabase(InfoSessionDAO session, SQLiteDatabase database)
    {
     ...
     */
    public boolean addInfoSession(InfoSessionDAO session, SQLiteDatabase database) {
